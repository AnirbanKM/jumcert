            ...
            <div class="row justify-content-center ">
                <div class="col-md-12">
                    ...
                    <div class="payment-form">
                        <div class="charge">
                            <p>You will be charged rs ${{ $price }} for Stream: {{ $sname }}</p>
                        </div>
                        <div class="card">
            ...
            stripe.handleCardPayment(clientSecret, cardElement, {
                ...
                .then(function(result) {
                    ...
                    if (result.error) {
                        ...
                        console.log("Stripe Server Response");
                        console.log(result);
                        ...
                        $.ajax({
                            ...
                            success: function(resp) {
                                // console.log("Private Stream Controller Controller Response...");
                                // console.log(resp);
                                if (resp.status === 200) {
                                    window.location.href =
                                        "{{ route('stream_payment_success') }}";
                                } else {
